...
# Get all of the dependencies of a module (follow deps up the tree)
function(vtk_get_module_deps vtk-module varName)
  set(${varName} ${VTK_MODULE_${vtk-module}_DEPENDS})
  foreach(dep IN LISTS VTK_MODULE_${vtk-module}_DEPENDS)
    list(LENGTH VTK_MODULE_${dep}_DEPENDS _listLength)
    if(_listLength GREATER 0)
      list(APPEND ${varName} ${VTK_MODULE_${dep}_DEPENDS})
    endif()
  endforeach()
  list( LENGTH ${varName} _len )
  if(_len GREATER 0)
...
function(vtk_add_library)
  ...
  vtk_get_module_deps(${vtk-module} ${vtk-module}-full-deps)
  message("The deps for ${vtk-module} are: '${${vtk-module}-full-deps}'")
  foreach(dep IN LISTS ${vtk-module}-full-deps)
